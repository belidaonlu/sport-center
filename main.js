...
const yogaFunc = () => {
    ...
    <img class="class-img" src="./img/yoga.jpg" alt="">`
};
const groupFunc = () => {
    classContent.innerHTML = `
    <img class="class-img" src="./img/group.webp" alt="">
...
const soloFunc = () => {
    ...
    <img class="class-img" src="./img/solo.jpg" alt="">`
};
const stretchingFunc = () => {
    classContent.innerHTML =  `
    <img class="class-img" src="./img/stret.webp" alt="">
    <div class="class-text">
...
//To enter the class where the buttons are located and listen the click event:
let classBtn = document.querySelector(".class-btn").addEventListener("click", selectBtn);

//Selecting a button and changing the content of the selected button:
function selectBtn(event) {
    const selectedBtn = event.target;
    const btn = document.querySelectorAll(".class-btn button")
    ...
    selectedBtn.style.backgroundColor = "#ec9b00";
